...
class __TwigTemplate_5bb9ba98e44f1df816a1ee249c4ec162e9f1dc79400874f5b5a4212bf46f670d extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 26
        if (((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "actions", [], "any", false, false, false, 26), "bulk", [], "any", false, false, false, 26)), 0)) && (1 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "data", [], "any", false, false, false, 26), "records_total", [], "any", false, false, false, 26), 0)))) {
            // line 27
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Blocks/bulk_actions.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Common\\Grid\\Blocks\\bulk_actions.html.twig");
    }
}
