...
class __TwigTemplate_d29e40e91b3398cf3771fa13f219eaefdbf7b683820ad74cf08d00fc45d2c765 extends Template
{
    private $source;
    private $macros = [];
...
";
  ...
  ";
        // line 82
        if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 82), "flashbag", [], "any", false, false, false, 82), "peek", [0 => "error"], "method", false, false, false, 82)), 0))) {
            // line 83
            echo "    ";
  ...
  ";
        ...
        // line 85
        echo "  ";
        if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 85), "flashbag", [], "any", false, false, false, 85), "peek", [0 => "failure"], "method", false, false, false, 85)), 0))) {
            // line 86
            echo "    ";
  ...
  ";
        ...
        // line 88
        echo "  ";
        if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 88), "flashbag", [], "any", false, false, false, 88), "peek", [0 => "success"], "method", false, false, false, 88)), 0))) {
            // line 89
            echo "    ";
  ...
  ";
        ...
        // line 91
        echo "  ";
        if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 91), "flashbag", [], "any", false, false, false, 91), "peek", [0 => "warning"], "method", false, false, false, 91)), 0))) {
            // line 92
            echo "    ";
  ...
  ";
        ...
        // line 94
        echo "  ";
        if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "session", [], "any", false, false, false, 94), "flashbag", [], "any", false, false, false, 94), "peek", [0 => "info"], "method", false, false, false, 94)), 0))) {
            // line 95
            echo "    ";
...
";
    ...
    public function macro_alert($__type__ = null, $__flashbagContent__ = null, ...$__varargs__)
    {
      ...
      ";
            // line 65
            if ((1 === twig_compare(twig_length_filter($this->env, ($context["flashbagContent"] ?? null)), 1))) {
                // line 66
  ...
  ";
    ...
    {
        return new Source("", "@PrestaShop/Admin/layout.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\layout.html.twig");
    }
}
