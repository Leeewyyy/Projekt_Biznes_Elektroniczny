...
class __TwigTemplate_59ba139747a9a4162bff6a0829f14dd6a8dec10d11166d8c459b8c1e78953c7d extends Template
{
    private $source;
    private $macros = [];
...
<tr class=\"column-filters";
  ...
  ";
    ...
    >
      ";
            // line 32
            if ((twig_get_attribute($this->env, $this->source, $context["loop"], "first", [], "any", false, false, false, 32) && (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "actions", [], "any", false, false, false, 32), "bulk", [], "any", false, false, false, 32)), 0)))) {
                // line 33
                echo "        ";
      ...
      ";
            // line 36
            if ((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "filter_form", [], "any", false, false, false, 36)), 1))) {
                // line 37
                echo "        ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Blocks/Table/filters_row.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Common\\Grid\\Blocks\\Table\\filters_row.html.twig");
    }
}
