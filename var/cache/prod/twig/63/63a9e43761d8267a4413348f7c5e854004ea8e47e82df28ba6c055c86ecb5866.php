...
class __TwigTemplate_7f2a578f8ff125f0805e08d059198f669062a03e70c0a952849cff3857485731 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        // line 42
        if (((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "actions", [], "any", false, false, false, 42), "bulk", [], "any", false, false, false, 42)), 0)) || (1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "filter_form", [], "any", false, false, false, 42)), 1)))) {
            // line 43
            echo "      ";
    ...
    public function block_grid_table_body($context, array $blocks = [])
    {
        ...
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "data", [], "any", false, false, false, 49), "records", [], "any", false, false, false, 49))) {
          ...
          ";
              ...
              ";
                    // line 54
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["column"], "type", [], "any", false, false, false, 54), "identifier"))) {
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Blocks/table.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Common\\Grid\\Blocks\\table.html.twig");
    }
}
