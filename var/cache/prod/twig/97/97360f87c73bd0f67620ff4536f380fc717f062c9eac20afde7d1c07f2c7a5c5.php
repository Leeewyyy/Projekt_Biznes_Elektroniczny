...
class __TwigTemplate_95ba81a9257186e56c0ab0635d040ecd5b8db43bf82315d79b98bf353266c3ce extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (twig_get_attribute($this->env, $this->source, ($context["attr"] ?? null), "counter", [], "any", true, true, false, 25)) {
            // line 26
            echo "  ";
            $context["isRecommandedType"] = (twig_get_attribute($this->env, $this->source, ($context["attr"] ?? null), "counter_type", [], "any", true, true, false, 26) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["attr"] ?? null), "counter_type", [], "any", false, false, false, 26), "recommended")));
            // line 27
...
";
    ...
    {
        return new Source("", "@Twig/form_max_length.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\TwigTemplateForm\\form_max_length.html.twig");
    }
}
