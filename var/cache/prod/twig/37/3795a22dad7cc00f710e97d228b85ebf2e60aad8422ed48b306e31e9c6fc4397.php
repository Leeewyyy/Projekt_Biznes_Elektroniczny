...
class __TwigTemplate_e6101d55098e6aa19f3751d94506929f1281fdc93291c754c7b83bd9a66a00b5 extends Template
{
    private $source;
    private $macros = [];
      ...
      <div id=\"multishop-modal\" class=\"multishop-modal multishop-modal-hidden js-multishop-modal\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"multishop-modal\" aria-hidden=\"true\">
        <div class=\"multishop-modal-dialog js-multishop-modal-dialog\" role=\"document\">
          <div class=\"multishop-modal-body\">
            ";
            // line 94
            if ((0 === twig_compare(($context["lockedToAllShopContext"] ?? null), false))) {
                // line 95
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["group"]) {
                ...
                // line 115
                if ((($context["isGroupContext"] ?? null) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["currentContext"] ?? null), "id", [], "any", false, false, false, 115), twig_get_attribute($this->env, $this->source, $context["group"], "id", [], "any", false, false, false, 115))))) {
                ...
                foreach ($context['_seq'] as $context["_key"] => $context["shop"]) {
                    ...
                    <span class=\"multishop-modal-color-container";
                    // line 125
                    if ((($context["isShopContext"] ?? null) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, ($context["currentContext"] ?? null), "id", [], "any", false, false, false, 125), twig_get_attribute($this->env, $this->source, $context["shop"], "id", [], "any", false, false, false, 125))))) {
                        echo " multishop-modal-color-check";
                    }
                    echo "\">
                      <i class=\"material-icons\">check</i>
                    ...
                    // line 129
                    if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["shop"], "hasMainUrl", [], "method", false, false, false, 129), false))) {
  ...
  ";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Multistore/header.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Multistore\\header.html.twig");
    }
}
