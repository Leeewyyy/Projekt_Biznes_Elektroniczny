...
class __TwigTemplate_c7e304c0706067f5bd8d895efc190513d12768c0257fdf397f3f52ddcd7f80fe extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 30
        if (((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "options", [], "any", false, true, false, 30), "sortable", [], "any", true, true, false, 30) && twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["column"] ?? null), "options", [], "any", false, false, false, 30), "sortable", [], "any", false, false, false, 30)) && (1 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["grid"] ?? null), "data", [], "any", false, false, false, 30), "records_total", [], "any", false, false, false, 30), 0)))) {
            // line 31
            echo "  ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Columns/Header/Content/default.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Common\\Grid\\Columns\\Header\\Content\\default.html.twig");
    }
}
