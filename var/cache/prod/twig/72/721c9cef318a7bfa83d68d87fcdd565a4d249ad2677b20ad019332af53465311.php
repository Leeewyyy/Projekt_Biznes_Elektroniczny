...
class __TwigTemplate_79876c3a57544000fc34ad70fb74db9eee18fff578865c8735a1e4cea1b103ea extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    >
        ...
        echo "-data\" class=\"typeahead-list nostyle col-sm-12 product-list\">
            ";
        // line 48
        if ((array_key_exists("collection", $context) && (1 === twig_compare(twig_length_filter($this->env, ($context["collection"] ?? null)), 0)))) {
            // line 49
            echo "                ";
...
";
    ...
    public function block_typeahead_product_pack_collection_widget($context, array $blocks = [])
    {
        ...
        echo (((array_key_exists("collection", $context) && (1 === twig_compare(twig_length_filter($this->env, ($context["collection"] ?? null)), 0)))) ? ("") : ("hide"));
        echo "\">";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/TwigTemplateForm/typeahead.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\TwigTemplateForm\\typeahead.html.twig");
    }
}
