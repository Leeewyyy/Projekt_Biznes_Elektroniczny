...
class __TwigTemplate_d2a03d86559631f1c601b6344ad7ea52be48195396695bc76d69478f3a225cc2 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function macro_check($__variable__ = null, ...$__varargs__)
    {
        ...
        try {
            // line 30
            echo "  ";
            (((array_key_exists("variable", $context) && (1 === twig_compare(twig_length_filter($this->env, ($context["variable"] ?? null)), 0)))) ? (print (twig_escape_filter($this->env, ($context["variable"] ?? null), "html", null, true))) : (print (false)));
            echo "
";
...
";
    ...
    public function macro_sortable_column_header($__title__ = null, $__sortColumnName__ = null, $__orderBy__ = null, $__sortOrder__ = null, $__prefix__ = null, ...$__varargs__)
    {
      ...
      ";
            // line 79
            if ((0 === twig_compare(($context["orderBy"] ?? null), ($context["sortColumnName"] ?? null)))) {
                // line 80
                echo "        data-sort-is-current=\"true\"
        data-sort-direction=\"";
                // line 81
                echo (((0 === twig_compare(($context["sortOrder"] ?? null), "desc"))) ? ("desc") : ("asc"));
                echo "\"
      ";
            }
            // line 83
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/macros.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\macros.html.twig");
    }
}
