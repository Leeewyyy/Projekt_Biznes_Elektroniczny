...
class __TwigTemplate_6cc34f2fa0238cd400158e40aca0bdc52fcb5146a4940626b0dc33f218dda699 extends Template
{
    private $source;
    private $macros = [];
...
>
  ";
        // line 49
        if ( !twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "icon", [], "any", false, false, false, 49))) {
            // line 50
            echo "    <i class=\"material-icons\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "icon", [], "any", false, false, false, 50), "html", null, true);
            echo "</i>
  ";
        }
        // line 52
        echo "  ";
        if ( !twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "tooltip_name", [], "any", false, false, false, 52)) {
            // line 53
            echo "    ";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["action"] ?? null), "name", [], "any", false, false, false, 53), "html", null, true);
            echo "
  ";
        }
        // line 55
...
";
    ...
    {
        return array (  126 => 55,  120 => 53,  117 => 52,  111 => 50,  109 => 49,  103 => 47,  98 => 45,  94 => 43,  92 => 42,  88 => 41,  84 => 40,  78 => 39,  75 => 38,  69 => 37,  66 => 36,  62 => 35,  59 => 34,  56 => 33,  54 => 32,  51 => 31,  47 => 29,  45 => 28,  42 => 27,  40 => 26,  37 => 25,);
    }

    public function getSourceContext()
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Actions/Row/link.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Common\\Grid\\Actions\\Row\\link.html.twig");
    }
}
