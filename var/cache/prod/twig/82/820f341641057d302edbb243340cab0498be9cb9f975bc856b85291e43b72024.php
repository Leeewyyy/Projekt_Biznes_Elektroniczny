...
class __TwigTemplate_6a156f59ba87b94466ecfe300fa99350e7a650c20e86e7674a46755dd7a0f835 extends Template
{
    private $source;
    private $macros = [];
...
<div
  class=\"module-item module-item-list col-md-12 ";
        // line 28
        if (((0 === twig_compare(($context["origin"] ?? null), "manage")) && (0 === twig_compare(($context["isModuleActive"] ?? null), "0")))) {
...
";
    ...
    public function block_addon_version($context, array $blocks = [])
    {
        ...
        // line 71
        echo "              ";
        if ((0 === twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["module"] ?? null), "attributes", [], "any", false, false, false, 71), "productType", [], "any", false, false, false, 71), "service"))) {
            // line 72
            echo "                ";
    ...
    public function block_addon_description($context, array $blocks = [])
    {
        ...
        echo "
            ";
        // line 87
        if (((1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["module"] ?? null), "attributes", [], "any", false, false, false, 87), "description", [], "any", false, false, false, 87)), 0)) && (-1 === twig_compare(twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["module"] ?? null), "attributes", [], "any", false, false, false, 87), "description", [], "any", false, false, false, 87)), twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["module"] ?? null), "attributes", [], "any", false, false, false, 87), "fullDescription", [], "any", false, false, false, 87)))))) {
            // line 88
            echo "              ...
            ";
        }
    ...
    public function block_module_actions($context, array $blocks = [])
    {
        ...
        // line 99
        echo "            ";
        if ((array_key_exists("requireBulkActions", $context) && (0 === twig_compare(($context["requireBulkActions"] ?? null), true)))) {
            // line 100
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/card_list.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Module\\Includes\\card_list.html.twig");
    }
}
