...
class __TwigTemplate_b4b61f0979a5797921fb8e440d47302c342868b12b4c896684c0b21f1b6a3ef1 extends Template
{
    private $source;
    private $macros = [];
...
<script>
    \$(document).ready(function() {
        var closable = ";
        // line 82
        if ((array_key_exists("closable", $context) && (0 === twig_compare(($context["closable"] ?? null), true)))) {
            echo "true";
        } else {
            echo "false";
        }
    ...
    public function block_footer($context, array $blocks = [])
    {
        ...
        if (array_key_exists("actions", $context)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["action"]) {
                // line 66
                echo "                            ";
                if ((twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", true, true, false, 66) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 66), "link")))) {
                    // line 67
                    echo "                                <a href=\"";
...
$context["action"], "type", [], "any", true, true, false, 68) && (0 === twig_compare(twig_get_attribute($this->env, $this->source, $context["action"], "type", [], "any", false, false, false, 68), "button")))) {
                    // line 69
    ...
    {
        return new Source("", "@PrestaShop/Admin/Helpers/bootstrap_popup.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Helpers\\bootstrap_popup.html.twig");
    }
}
