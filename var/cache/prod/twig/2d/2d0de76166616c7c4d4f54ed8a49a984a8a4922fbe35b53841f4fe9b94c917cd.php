...
class __TwigTemplate_37bd9e7bc4c45a6adaae5c3813b6657d0bedd122de8fb6187c68f4fa3d320669 extends Template
{
    private $source;
    private $macros = [];
...
($context["app"] ?? null), "request", [], "any", false, false, false, 35), "query", [], "any", false, false, false, 35), "get", [0 => "id_cms_category"], "method", false, false, false, 35)]), "desc" => $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("Add new page", [], "Admin.Design.Help"), "icon" => "add_circle_outline"]];
  ...
  ";
    ...
    public function block_cms_category_grid($context, array $blocks = [])
    {
        ...
        // line 51
        echo "    ";
        $this->loadTemplate("@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", 51, "1496848001")->display(twig_array_merge($context, ["grid" => ($context["cmsCategoryGrid"] ?? null)]));
        // line 58
        echo "  ";
    }
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Improve/Design/Cms/index.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Improve\\Design\\Cms\\index.html.twig");
    }
}


/* @PrestaShop/Admin/Improve/Design/Cms/index.html.twig */
class __TwigTemplate_37bd9e7bc4c45a6adaae5c3813b6657d0bedd122de8fb6187c68f4fa3d320669___1496848001 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_grid_panel_footer($context, array $blocks = [])
    {
        ...
        // line 53
        echo "        ";
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 53), "query", [], "any", false, false, false, 53), "get", [0 => "id_cms_category"], "method", false, false, false, 53) && (0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["app"] ?? null), "request", [], "any", false, false, false, 53), "query", [], "any", false, false, false, 53), "get", [0 => "id_cms_category"], "method", false, false, false, 53), twig_get_attribute($this->env, $this->source, ($context["cmsPageView"] ?? null), "root_category_id", [], "any", false, false, false, 53))))) {
            // line 54
            echo "          ";
