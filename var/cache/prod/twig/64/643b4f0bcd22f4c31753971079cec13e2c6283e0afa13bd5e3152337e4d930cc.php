...
class __TwigTemplate_beb54517b29e65e48d17846af213aa56f304007c756b52b5271f285d9cc1df1f extends Template
{
    private $source;
    private $macros = [];
...
($context["module"] ?? null), "attributes", [], "any", false, false, false, 33), "actionTranslationDomains", [], "any", false, false, false, 33)];
  ...
  ";
        // line 36
        if ((0 === twig_compare(($context["url_active"] ?? null), "buy"))) {
            // line 37
...
($context["transDomains"] ?? null)]));
            // line 50
            echo "    ";
            if ((1 === twig_compare(twig_length_filter($this->env, ($context["urls"] ?? null)), 1))) {
                // line 51
        ...
        <div class=\"dropdown-menu\">
          ";
                ...
                foreach ($context['_seq'] as $context["module_action"] => $context["module_url"]) {
                    // line 58
                    echo "            ";
                    if ((0 !== twig_compare($context["module_action"], ($context["url_active"] ?? null)))) {
                        // line 59
                        echo "                <li>
                  ";
                        // line 60
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/action_menu.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Module\\Includes\\action_menu.html.twig");
    }
}
