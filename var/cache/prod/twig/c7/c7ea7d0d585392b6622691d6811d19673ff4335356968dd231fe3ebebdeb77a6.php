...
class __TwigTemplate_7759cbc060c8357cd60d64e5990cac90278a53cc739952260f1423020801e374 extends Template
{
    private $source;
    private $macros = [];
        ...
        <ol class=\"breadcrumb\">
          ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["category"]) {
              ...
              ";
                // line 35
                if ((0 !== twig_compare(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["category"], "cmsPageCategoryId", [], "any", false, false, false, 35), "value", [], "any", false, false, false, 35), twig_get_attribute($this->env, $this->source, ($context["cmsPageView"] ?? null), "root_category_id", [], "any", false, false, false, 35)))) {
                    // line 36
                    echo "                ";
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Improve/Design/Cms/Blocks/breadcrumb.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Improve\\Design\\Cms\\Blocks\\breadcrumb.html.twig");
    }
}
