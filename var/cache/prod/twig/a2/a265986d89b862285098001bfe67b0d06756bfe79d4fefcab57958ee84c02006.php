...
class __TwigTemplate_85e57b256e195db91a796a602ff2cdeaf9470f25121fb8002675612c3bfa1a25 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["action"]) {
                ...
                if (twig_get_attribute($this->env, $this->source, $context["action"], "isApplicable", [0 => ($context["record"] ?? null)], "method", false, false, false, 33)) {
                    // line 34
                    echo "        ";
                    if ((0 === twig_compare((($__internal_compile_0 = twig_get_attribute($this->env, $this->source, $context["action"], "options", [], "any", false, false, false, 34)) && is_array($__internal_compile_0) || $__internal_compile_0 instanceof ArrayAccess ? ($__internal_compile_0["use_inline_display"] ?? null) : null), true))) {
                        // line 35
                        echo "            ";
...
$context["action"]]);
          ...
          ";
                // line 83
                echo "          ";
                if ((1 === twig_compare(twig_length_filter($this->env, ($context["regularActions"] ?? null)), ($context["skippedActions"] ?? null)))) {
                    // line 84
...
";
    ...
    {
        return new Source("", "@PrestaShop/Admin/Common/Grid/Columns/Content/action.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Common\\Grid\\Columns\\Content\\action.html.twig");
    }
}
