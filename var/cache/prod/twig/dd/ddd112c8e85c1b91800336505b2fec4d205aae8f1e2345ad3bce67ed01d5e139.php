...
class __TwigTemplate_e0a721df27985353729f25e0256026823f756fd80c165d71e08e15d34c95e411 extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"row\">
    ...
    ";
        // line 49
        if ((array_key_exists("requireFilterStatus", $context) && (0 === twig_compare(($context["requireFilterStatus"] ?? null), true)))) {
            // line 50
            echo "      <div class=\"col-md-4 module-top-menu-item\">
        <h3>";
            // line 51
    ...
    ";
        // line 56
        if (((1 === twig_compare(($context["level"] ?? null), twig_constant("PrestaShopBundle\\Security\\Voter\\PageVoter::LEVEL_UPDATE"))) && array_key_exists("bulkActions", $context))) {
            // line 57
...
($context["js_translatable"] ?? null));
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/menu_top.html.twig", "C:\\wamp64\\www\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Module\\Includes\\menu_top.html.twig");
    }
}
