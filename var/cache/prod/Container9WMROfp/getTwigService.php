...
$instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('8.0.0', '%s?%s'), new \Symfony\Component\Asset\Context\RequestStackContext($c, '', false)), [])));
...
$instance->addExtension(($this->services['prestashop.twig.extension.multistore_header_extension'] ?? $this->load('getPrestashop_Twig_Extension_MultistoreHeaderExtensionService.php')));
...
$instance->addExtension(($this->services['prestashop.adapter.twig.locale_extension'] ?? $this->load('getPrestashop_Adapter_Twig_LocaleExtensionService.php')));
